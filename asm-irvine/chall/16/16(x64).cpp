...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow)
{
	...
	{
		MessageBox(NULL, TEXT("Program requires Windows NT!"), (LPCWSTR)(szAppName), MB_ICONERROR);
		return 0;
	}
	hwnd = CreateWindow((LPCWSTR)(szAppName), L"AntiChrome", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 200, 50, NULL, NULL, hInstance, NULL);
