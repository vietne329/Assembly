...
eData byte 2Eh, 65h, 64h, 61h, 74h, 61h,0,0
numEdata dword 0
nameEdata dword 0
eDataVA dword 00000000
edataRawData dword 00000000
eDataRVA dword 0 
...
calRVAExportTable proc
	;receive rva -> raw offset 
	push ebp
	mov ebp,esp
	push ebx
	mov eax, dword ptr [eDataVA]
	sub eax, dword ptr [edataRawData]
	mov ebx, dword ptr [ebp+8]
	sub ebx, eax
	xchg eax, ebx
	pop ebx
...
loopFindedata:
	...
	call getBuf
	mov esi, dword ptr [buf]
	mov dword ptr [eDataVA],esi
	add eax,8 
	push eax
	push 4
	call getBuf
	mov esi,dword ptr [buf]
	mov dword ptr [edataRawData],esi
	;push dword ptr [eDataRVA]
	;call calRVAImportTable
	;esi have the raw offset of edata
	mov eax,esi
	add eax,20h
	push eax
	push 4
	...
	mov eax, dword ptr[buf]
	mov dword ptr [nameEdata],eax
	push dword ptr [nameEdata]
	call calRVAExportTable
	mov dword ptr [nameEdata],eax
	...
	mov eax, dword ptr[buf]
	mov dword ptr [numEdata],eax
	;
	mov ecx, dword ptr [numEdata]
	;push dword ptr [nameEdata]
	
	mov edi,dword ptr [nameEdata]
loopfi:
	;push edi
	;call calRVAExportTable
	;call WriteHex
